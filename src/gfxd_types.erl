...
struct_info_ext('JSONNode') ->
  {struct, [{1, optional, {map, string, {struct, {'gfxd_types', 'JSONField'}}}, 'pairs', #{}},
...
struct_info_ext('ServiceMetaData') ->
  {struct, [{1, required, string, 'productName', undefined},
          ...
          {15, required, {map, i32, {set, i32}}, 'supportedCONVERT', #{}},
          ...
          {45, required, {map, i32, bool}, 'transactionDefaults', #{}},
          {46, required, i32, 'rowIdLifeTime', undefined},
          {47, required, {set, i32}, 'supportedFeatures', sets:new()},
          {48, required, {map, i32, {list, i32}}, 'featuresWithParams', #{}}]}
;
...
struct_info_ext('StatementAttrs') ->
  {struct, [{1, optional, byte, 'resultSetType', undefined},
          ...
          {17, optional, {map, i32, bool}, 'pendingTransactionAttrs', #{}}]}
;
...
struct_names() ->
  ['FieldDescriptor', 'Decimal', 'Timestamp', 'FieldValue', 'PDXNode', 'PDXObject', 'PDXSchemaNode', 'PDXSchema', 'JSONField', 'JSONNode', 'JSONObject', 'BlobChunk', 'ClobChunk', 'ServiceMetaData', 'ServiceMetaDataArgs', 'OpenConnectionArgs', 'ConnectionProperties', 'HostAddress', 'GFXDExceptionData', 'StatementAttrs', 'DateTime', 'ColumnValue', 'ColumnDescriptor', 'Row', 'OutputParameter', 'RowSet', 'PrepareResult', 'UpdateResult', 'StatementResult', 'EntityId'].
...
enum_names() ->
  ['FieldType', 'GFXDType', 'TransactionAttribute', 'RowIdLifetime', 'ServiceFeature', 'ServiceFeatureParameterized', 'ServiceMetaDataCall', 'SecurityMechanism', 'ServerType'].
